...
The Collision Fader prefab makes it easy to prevent unwanted clipping of collidable geometry by fading the scene cameras when the headset collides with geometry.
...
* Adjust the [project manifest file][Project-Manifest] `manifest.json` in a text editor.
  ...
  * Add `io.extendreality.tilia.visuals.collisionfader.unity` to `dependencies`, stating the latest version.
  ...
  ```json
  {
    ...
    "dependencies": {
      "io.extendreality.tilia.visuals.collisionfader.unity": "X.Y.Z",
      ...
    }
  }
  ```
...
The `Tilia Visuals CollisionFader Unity` package will now be available in your Unity project `Packages` directory ready for use in your project.
